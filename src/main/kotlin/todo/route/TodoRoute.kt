    ...
    route("/todos") {
        ...
        get("/{id?}") {
            try {
                ...
                call.respond(
                        ...
                        GlobalResponse(500, false, e.toString())
                )
            }
        }
            ...
            try {
                ...
                call.respond(
                        ...
                        GlobalResponse(
                                200,
                                true,
                                "Successfully imported todo data with $todos rows"
                        )
                )
            } catch (e: Exception) {
                call.respond(
        ...
        post("/hash") {
            try {
                ...
                //                val element: CharArray =
                // Json.encodeToString(password).toCharArray()
                ...
                call.respond(
                        ...
                        GlobalResponseData(
                                ...
                                mapOf(
                                        ...
                                        "password_array" to password.toString(),
                                        "hash" to hash
                                )
                        )
                )
    ...
    route("/api/v2/") {
            ...
            try {
                ...
                call.respond(
                        ...
                        GlobalResponse(
                                201,
                                true,
                                "Todo with ID #${resultMap.component1()} has been added."
                        )
                )
            } catch (e: SerializationException) {
                call.respond(
                        HttpStatusCode.BadRequest,
                        GlobalResponse(400, false, "Invalid JSON types: ${e.localizedMessage}")
                )
            } catch (e: CannotTransformContentToTypeException) {
                call.respond(
                        HttpStatusCode.BadRequest,
                        GlobalResponse(400, false, "Wrong input: ${e.localizedMessage}")
                )
            } catch (e: Exception) {
                call.respond(
                        HttpStatusCode.InternalServerError,
                ...
                val id: Int =
                        call.parameters["id"]?.toIntOrNull()
                                ?: return@patch call.respond(
                                        status = HttpStatusCode.BadRequest,
                                        GlobalResponse(400, false, "Missing id")
                                )
                val raw = call.receiveText()
                val element = Json.parseToJsonElement(raw)
                val obj = element.jsonObject
                    ...
                    0 ->
                            call.respond(
                                    ...
                                    GlobalResponse(
                                            500,
                                            false,
                                            "Could not update Todo. Please try again."
                                    )
                            )
                    1 ->
                            call.respond(
                                    HttpStatusCode.OK,
                                    GlobalResponse(200, true, "Todo updated successfully.")
                            )
                }
            } catch (e: Exception) {
                call.respond(
        ...
        delete("delete/{id?}") {
            try {
                ...
                if (checkValue < 1)
                        return@delete call.respond(
                                ...
                                GlobalResponse(
                                        500,
                                        false,
                                        "Deletion not successful, please try again."
                                )
                        )
                ...
                call.respond(
                        status = HttpStatusCode.BadRequest,
                        GlobalResponse(500, false, "Server Error: ${e.toString()}")
                )
            }
        }
    }
